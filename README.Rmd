...
You will need a personal Linear API key in order to use this package. This can be generated at the [security settings page](https://linear.app/presagegroup/settings/account/security) within linear. 
